...
const pages = {
  ...
  EmailNotificationsPage: {
    ...
    toggle: {
      text: "电子邮件通知",
      expl: "通过电子邮件随时了解您不在时PG发生的事情。您可以随时关闭此设置。",
    },
    postList: [
      {
        title: "关于我或我的帖子",
  ...
  PushNotificationsPage: {
    ...
    toggle: {
      text: "推送通知",
      expl: "在离开时接收关于PG中发生的事情的推送通知。您可以随时关闭通知。",
    },
    empty: {
      title: "开启推送通知",
      expl: "通过推送通知，实时接收正在发生的事情的消息。即使不登录PG，您也能收到通知。通知随时可以关闭。",
    },
    button: {
      text: "开启",
    },
    list: [
      {
        ...
        description:
          "当你开启关于我关注的人的帖子通知时，将会收到他们的帖子或直播视频的通知。",
      },
      {
        text: "提及和回复",
        type: "checkboxlist",
